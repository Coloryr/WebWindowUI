...
public sealed class WindowsWindow : IWindowBackend
{
    ...
    private async Task InitWebViewAsync()
    {
        try
        {
            ...
            CoreWebView2 core = _controller.CoreWebView2;
        ...
        {
            Win32.ShowError($"WebView2 初始化失败：{ex.Message}\n请确认已安装 WebView2 运行时。");
        }
    }
    ...
    private void OnWebResourceRequested(object? sender, CoreWebView2WebResourceRequestedEventArgs args)
    {
        try
        {
            ...
            bool isData = WebResourceLocator.IsScheme(args.Request.Uri, _options.DataScheme);
